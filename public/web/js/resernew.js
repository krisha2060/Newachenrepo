...
minDate.setDate(today.getDate() ); // Add 1 day
...
(function () {
    ...
    function initEditMode(eb) {
        ...
        const hero = document.getElementById('reservationHero');
        if (hero) hero.style.display = 'none';

        const cateringSection = document.getElementById('cateringSection');
        if(cateringSection) cateringSection.textContent = 'Edit Package & Details For ' + eb.name;
